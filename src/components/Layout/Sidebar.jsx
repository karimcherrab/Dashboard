        ...
        <>
          <div className=" h-[10%] flex justify-center items-center">
            ...
            >
              ...
              <h1 className=" text-[30px] text-gray-400 font-semibold" >Admin</h1>
              
            </Link>
          </div>

          <div className=" h-[80%] flex flex-col justify-center items-center mt-4">
            {linksPremium.map((link) => (
              <div className="flex flex-col gap-3 justify-around items-start h-full  w-[85%]" key={link.title}>
